...
class Map extends React.Component {
    ...
    render() {
        ...
        const {selectedIndexs,island } = this.state;

        let cells = new Array(size * size);
        for (let i = 0; i < cells.length; i++) {
            if (this.props.mapargs.selectionMode && selectedIndexs.includes(i)&& !island.includes(i)) {
